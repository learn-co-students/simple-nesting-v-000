...
puts describe "nested hash" do
  ...
  puts describe "#alan_kay_is_known_for" do
...
puts  describe "#dennis_ritchies_language" do
  ...
  puts describe "#changing_alan" do
  ...
  puts describe "#adding_to_dennis" do
